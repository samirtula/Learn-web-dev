    ...
    <section class="docs">
      <div class="docs__wrapper">
        <table class="docs__nav-table">
          <tbody>
            <tr>
              <td><a href="#">Документы</a></td>
              <td><a href="#">Бланки документы</a></td>
              <td><a href="#">Законодательство</a></td>
              <td><a href="#">Работа правления</a></td>
              <td><a href="#">Благоустройство</a></td>
        ...
        <table class="docs__table">
          ...
          <tbody>
            <tr>
              <td>Устав СНТ</td>
              <td>21.10.2020  17:30</td>
              <td><a href="#"><img class="docs__download-image" src="images/documents/download.svg"></a></td>
            </tr>
            <tr>
              <td>Порядок приема в СНТ</td>
              <td>21.10.2020  17:30</td>
              <td><a href="#"><img class="docs__download-image" src="images/documents/download.svg"></a></td>
            </tr>
          </tbody>
