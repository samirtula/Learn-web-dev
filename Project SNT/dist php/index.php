    ...
    <section class="team">
      <div class="team__wrapper">
        ...
        <div class="team__block">
          <div class="team__block-wrapper">
            <div class="team__block-inner contact">
              <div class="contact__image contact__image-employee"></div>
              <div class="contact__name"><span class="contact__text">Иванов Иван Иванович <br> Председатель СНТ</span></div>
            </div>
            <div class="team__block-inner contact">
              <div class="contact__image contact__image-employee_1"></div>
              <div class="contact__name"><span class="contact__text">Иванов Иван Иванович <br> Охранник СНТ</span></div>
            </div>
          </div>
          <div class="team__block-wrapper">
            <div class="team__block-inner contact">
              <div class="contact__image contact__image-employee_2"></div>
              <div class="contact__name"><span class="contact__text">Иванов Иван Иванович <br> Бухгалтер СНТ</span></div>
            </div>
            <div class="team__block-inner contact">
