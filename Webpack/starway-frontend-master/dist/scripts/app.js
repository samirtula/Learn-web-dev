...
/* harmony import */ var _order_history__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./order-history */ "./scripts/order-history.js");
/* harmony import */ var _order_history__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_order_history__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _personal_info__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./personal-info */ "./scripts/personal-info.js");
/* harmony import */ var _personal_info__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_personal_info__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _popular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./popular */ "./scripts/popular.js");
/* harmony import */ var _popular__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_popular__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _login_and_register__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./login-and-register */ "./scripts/login-and-register.js");
/* harmony import */ var _login_and_register__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_login_and_register__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _catalog__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./catalog */ "./scripts/catalog.js");
/* harmony import */ var _catalog__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_catalog__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./cart */ "./scripts/cart.js");
...
/* harmony import */ var _card__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./card */ "./scripts/card.js");
/* harmony import */ var _card__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_card__WEBPACK_IMPORTED_MODULE_8__);
...
$(document).ready(function () {
  $('.js-show-menu').on('click', function (e) {
    e.preventDefault();
    console.log('click'); //$('html').toggleClass('fixed');
  ...
  $('.js-hide-menu').on('click', function (e) {
    e.preventDefault();
    console.log('hide menu'); //$('html').toggleClass('fixed');

    $('.main-menu').slideUp();
  });
  $('.js-slide-image a span').hover(function (e) {
    var index = $(this).closest('a').attr('data-index');
    var aImage = $('.main-menu__images img[data-slideimg=' + index + ']');
  ...
  var sticky = new sticky_js__WEBPACK_IMPORTED_MODULE_1___default.a('.js-sticky-menu');
  /*let deg = 0;
  function rotate() {
      deg++;
...
$(document).ready(function () {
  if (document.querySelector(".main-page-card")) {
    var scrollBlock = document.querySelector(".card-main__element--photo ");
    var galleryItems = document.querySelectorAll(".card-main__element--gallery div");
    ...
    var colorBlockElems = document.querySelectorAll(".wrap-colors div");
    var infoColor = document.querySelector(".info-color-value");
    colorBlockElems.forEach(function (item, i) {
      item.addEventListener("click", function () {
        var _iterator2 = _createForOfIteratorHelper(colorBlockElems),
            _step2;
    ...
    if (buyBtn) {
      buyBtn.addEventListener("click", function (e) {
        e.preventDefault();
        $(".add-to-cart-menu").css("display", "flex"); // заблокировать скролл страницы
    ...
    var counterSpan = document.querySelectorAll(".counter span");
    ...
    var mainSliderBtns = document.querySelectorAll(".arrow-btn-block__item");
    mainSliderBtns.forEach(function (elem, i) {
      elem.addEventListener("click", function () {
        var photoPosition = parseFloat($(".photo").css("left"));
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  if (document.querySelector(".main-page-cart")) {
    console.log("cart");
    var cartResult = document.querySelector(".cart-result");
    var cartFlexContainer = document.querySelector(".flex-container");
    ...
    var cartProductsItem = document.querySelectorAll(".cart-products__item");
    ...
    var counterValue = document.getElementsByClassName("counter__value");
    var infoPrice = document.getElementsByClassName("info-price--product");
    var gift = document.querySelector(".cart-products__item--gift");
    var cartResultPrice = document.querySelector(".cart-result-price");
    cartProductsItem.forEach(function (elem, i) {
      elem.addEventListener("click", function (e) {
        ...
        var price = infoPrice[i - ind].getAttribute("price");
    ...
    function total() {
      ...
      for (var k = 0; k <= cartProductsItem.length; k++) {
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  if (document.querySelector(".order-history")) {
    ...
    var orderNums = document.querySelectorAll(".order-num");
    var orderDates = document.querySelectorAll(".order-date");
    var orderTracknums = document.querySelectorAll(".order-tracknum");
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  if (document.querySelector(".main-page-personal-info")) {
    ...
    for (var i = 2; i <= 32; i++) {
      ...
      var optionsMonth = selectMonth.getElementsByTagName("option");

      for (var _i = 2; _i <= 13; _i++) {
        createOption = document.createElement('option');
        selectMonth.append(createOption);
        optionsMonth[_i - 1].innerHTML = _i - 1;
      }

      var selectYear = document.querySelector("select[name='year']");
      var optionsYear = selectYear.getElementsByTagName("option");

      for (var _i2 = 1961; _i2 <= 2000; _i2++) {
        createOption = document.createElement('option');
        selectYear.append(createOption);
        optionsYear[_i2 - 1960].innerHTML = _i2 - 1;
      }
    }

    var mediaQueryCartDesktop = window.matchMedia('(min-width: 1024px)');
    var mediaQueryCartTablet = window.matchMedia('(max-width: 1024px)');
    var mediaQueryCartSmall = window.matchMedia('(max-width: 767px)'); // функция смены заголовков и инпута "email"
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  if (document.querySelector(".popular")) {
    var alsoLikeSliderBtns = document.querySelectorAll(".popular__buttons div");
    alsoLikeSliderBtns.forEach(function (elem, i) {
      elem.addEventListener("click", function () {
        console.log("www");
        var photoPosition = parseFloat($(".popular__element").css("left"));
