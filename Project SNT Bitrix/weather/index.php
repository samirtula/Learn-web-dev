        ...
        <div class="weather__today">
          <div class="weather__inner-image">
            ...
            <div class="weather__info">
                ...
                <span class="weather__info-text"> <img src="../local/templates/snt/images/weather/arrow.svg" class="wind"> Направление ветра: <?=$weather->windDir . '<br>'?></span>
                <span class="weather__info-text"> <img src="../local/templates/snt/images/weather/prob.svg"> Вероятность осадков: <?=$weather->precProb . '%.'?></span>
                <span class="weather__info-text"> <img src="../local/templates/snt/images/weather/humidity.svg"> Влажность: <?= $weather->humidity .  '%.<br>'?></span></div>
            </div>
          </div>
      </div>
    </section>
