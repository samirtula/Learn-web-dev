...
CJSCore::Init();
?>
<? if ($USER->IsAuthorized()) header("Location: /private/"); ?> <!--Переводим авторизованных пользователей на родительской странице -->
<div class="bx-system-auth-form">
    ...
    <? if ($arResult["FORM_TYPE"] == "login"): ?>
        <h3 class="title">Войти в систему</h3>                            <!--Форма авторизации-->
                ...
                if ($arResult["NEW_USER_REGISTRATION"] == "Y"): ?>
                    <tr>
                        <td colspan="2" align="left">
                            <noindex><a style="margin-top: 0; margin-bottom: 20px " class="cabinet_header cabinet-link"
    ...
    <?
        ...
        <form action="<?= $arResult["AUTH_URL"] ?>">
            <table width="290px">
                <tr>
                    <td align="left">
                        <span class="cabinet_header">Имя: <?= $arResult["USER_NAME"] ?></span><br/>
                        <span class="cabinet_header">Логин: [<?= $arResult["USER_LOGIN"] ?>]</span><br/>
                        <a href="<?= $arResult["PROFILE_URL"] ?>"
                           title="<?= GetMessage("AUTH_PROFILE") ?>"><span class="cabinet_header cabinet-link">Перейти в личный кабинет</span></a><br/>
                    </td>
                </tr>
                <tr>
                    <td align="center">
